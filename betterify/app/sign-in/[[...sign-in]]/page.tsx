...
export default function SignInPage() {
  ...
  const handleOTPStart = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("Error during OTP start:", err)
      setError(err.errors?.[0]?.message || "Something went wrong. Please try again.")
    } finally {
      setLoading(false)
    }
  ...
  const handleOAuthSignIn = async (provider: "oauth_google" | "oauth_github" | "oauth_spotify") => {
    if (!isLoaded) return
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-2">
                ...
                <Button
                  variant="outline"
                  className="w-full"
                  onClick={() => handleOAuthSignIn("oauth_spotify")}
                  disabled={loading}
                >
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                  ...
                  <form onSubmit={handleEmailSignIn} className="space-y-4 mt-4">
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <Link href="/sign-in/reset-password" className="text-xs text-primary hover:underline">
                          Forgot password?
                        </Link>
                      </div>
                      <Input
                ...
                <TabsContent value="otp">
                  {!verifying ? (
                    <form onSubmit={handleOTPStart} className="space-y-4 mt-4">
                      <div className="space-y-2">
